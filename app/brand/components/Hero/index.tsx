...
function BrandHeroSection() {
  return (
    <div className="w-full container">
      <div className="grid grid-rows-[max-content_max-content-max-content] md:grid-rows-[max-content_auto] md:grid-cols-[1fr_0.8fr] h-full md:gap-y-10">
        ...
        <div className="row-start-1 flex items-center justify-center w-full h-full">
          <HeaderImages img="bull" height={246} width={386} />
        </div>
      </div>
    </div>
  );
